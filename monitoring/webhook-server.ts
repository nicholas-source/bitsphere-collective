...
app.get('/health', (req: Request, res: Response) => {
  res.status(200).json({ 
    status: 'ok',
    timestamp: new Date().toISOString(),
    contract: 'SPR54P37AA27XHMMTCDEW4YZFPFJX69162JR5CT4.bitsphere-collective'
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`📡 Listening for events from: SPR54P37AA27XHMMTCDEW4YZFPFJX69162JR5CT4.bitsphere-collective`);
