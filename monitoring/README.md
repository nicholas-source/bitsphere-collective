...
**Contract Address:** `SPR54P37AA27XHMMTCDEW4YZFPFJX69162JR5CT4.bitsphere-collective`
...
curl -X POST http://localhost:3000/events/member-joined \
  ...
  -d '{
    "member": "SPR54P37AA27XHMMTCDEW4YZFPFJX69162JR5CT4",
    "amount": 5000000,
    "block": 12345
  }'
```
...
- Contract on Explorer: <https://explorer.hiro.so/txid/SPR54P37AA27XHMMTCDEW4YZFPFJX69162JR5CT4.bitsphere-collective?chain=mainnet>
